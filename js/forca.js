...
function mudarStyleLetra(tecla, condicao){
    if(condicao == false)
    {
        document.getElementById(tecla).style.background = "#f70505";
...
function carregaListaAutomatica(){
    palavras = [
        palavra001 = {
            nome: "GEFORCE NOW",
            categoria:"JOGOS EM NUVEM"
        },
        palavra002 = {
            nome: "SMART MAGIC",
            categoria:"FUNCIONA COMO MOUSE"
        },
        palavra003 = {
            nome: "AIR PLAY",
            categoria:"IOS"
        ...
        palavra004 = {
            nome: "ALERTA DE ESPORTES",
            categoria:"ESPORTE PREFERIDO"
        },
        palavra005 = {
            nome: "PROCESSADOR",
            categoria:"MELHORAMENTO DE IMAGEM"
        },
        palavra006 = {
            nome: "WEB OS",
